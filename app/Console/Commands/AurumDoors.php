...
class AurumDoors extends Command
{
    const URL = 'https://aurumdoors-shop.ru';
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'parsing:aurum';
     ...
     * @var string
     */
    protected $description = 'Парсинг https://aurumdoors-shop.ru';
    ...
    {
        $page = 'https://aurumdoors-shop.ru/catalogue/show/co-1-kobalt/';
        $url = $this->url_connect($page);
        dd($url);

        $this->file = fopen('aurum.csv', 'w');
...
//                dd($this->priceList);
    ...
    public function url_connect($url)
    {
        $ch = curl_init();
