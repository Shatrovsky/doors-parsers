...
class KennermebelTables extends Command
{
     ...
     * @var string
     */
    protected $signature = 'parsing:kennermebel-tables';
    ...
    protected $urls = [
        'https://kennermebel.ru/collection/kuhonnye-stoly' => [
            'name' => 'Кухонные столы'
        ],
        'https://kennermebel.ru/collection/kamennye' => [
            'name' => 'Керамика'
        ],
        'https://kennermebel.ru/collection/steklyannye' => [
            'name' => 'Стекло'
        ],
        'https://kennermebel.ru/collection/derevyannye' => [
            'name' => 'Дерево'
        ],
    ];
    ...
    {
        $this->file = fopen('kennermebel_tables.csv', 'w');
    ...
    private function setFilters(Product $product, Crawler $crawler)
    {
        ...
        $titles = [
            ...
            'Общие|Размер' => 'commonSize',
            'Столешница|Цвет' => 'tableColor',
            'Столешница|Покрытие' => 'tableCoverage',
            'Столешница|Материал' => 'tableMaterial',
            'Столешница|Толщина стекла' => 'tableGlassDepth',
            'Столешница|Толщина подложки' => 'tableMainDepth',
            'Механизм|Тип' => 'mechanismType',
            'Механизм|Особенности' => 'mechanismCustom',
            'Вставка|Тип' => 'insertType',
            'Вставка|Материал' => 'insertMaterial',
            'Опоры|Цвет' => 'supportColor',
            'Опоры|Материал' => 'supportMaterial',
            'Опоры|Покрытие' => 'supportCoverage',
            'Опоры|Особенности' => 'supportCustom',
        ];
        $title = '';
        $value = '';
        $itemGroup = '';
